...
import TaskTypedRadioGrouped from './TaskTypedRadioGrouped';
...
function Modal() {
    ...
    const [addTask,newTaskInput, setNewTaskInput,image,setImage,newTaskTyped] = useBoardStore((state) => [
        state.addTask,
        state.newTaskInput,
